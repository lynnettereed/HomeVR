$(document).ready(() => {
  ...
  function handleExitVRMode(e) {
    ...
    //const content = '<div class="img-container"><img id="img-baseline" src="./public/images/Foster_Ext_FrontRight_AmericanClassic.jpg" alt=""><img id="img-garage" class="overlay-img" src=""><img id="img-sunroom" class="overlay-img" src=""></div>'
